...
<strong>This mod will again, be disabled for non-host clients if the host does not have this mod for various reasons.<br>
For those stubborn enough, this can be force allowed in the config. You have been warned!</strong><br>
